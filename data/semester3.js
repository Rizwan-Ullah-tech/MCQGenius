    ...
    "Building Angular Applications with TypeScript": {
      "Session 1": [
        ...
        },
        {
          ...
          answer: "Map keys to values without the disadvantages of using Objects."
        }
      ],
      "Session 2": [
        {
        ...
        },
        {
          ...
          answer: "Poor compatibility with legacy browsers"
        }
      ],
      "Session 3": [
        {
          ...
          answer: "HTML template, Class, Metadata"
        },
        {
      ...
      "Session 4": [
        ...
        },
        {
          ...
          answer: "Property Binding and Event Binding"
        }
      ],
      "Session 5": [
        {
        ...
        },
        {
          ...
          answer: "To loop over an iterable and add elements to the DOM"
        },
        {
        ...
        },
        {
          ...
          answer: "To group elements without adding an extra element to the DOM"
        }
      ],
      "Session 6": [
        {
          ...
          answer: "To make code more flexible, testable, and mutable"
        },
        {
        ...
        },
        {
          ...
          answer: "To create service instances and inject them into classes"
        },
        {
        ...
        },
        {
          ...
          answer: "An Observable can handle multiple values over time, while a Promise provides a single value."
        }
      ],
      "Session 7": [
        {
          ...
          answer: "To transform data before displaying it in the view"
        },
        {
      ...
      "Session 8": [
        ...
        },
        {
          ...
          answer: "As dynamic, essential parts of the route definition"
        },
        {
        ...
        },
        {
          ...
          answer: "To identify and verify a user"
        },
        {
      ...
      "Session 9": [
        {
          ...
          answer: "A UI component library following Google's Material Design"
        },
        {
    ...
    "Developing Applications with C#": {
      "Session 1": [
        {
          ...
          answer: "A platform created by Microsoft for building applications"
        },
        {
        ...
        },
        {
          ...
          answer: "To act as the output code when a .NET language is compiled"
        },
        {
          ...
          answer: "It integrates tools like ASP.NET Core and Entity Framework Core."
        },
        {
      ...
      "Session 2": [
        ...
        },
        {
          ...
          answer: "To declare a variable with a fixed, unchangeable value."
        },
        {
        ...
        },
        {
          ...
          answer: "Read a line of text from the console."
        },
        {
        ...
        },
        {
          ...
          answer: "To make programs simpler by omitting the Main method boilerplate."
        }
      ],
      "Session 3": [
        {
        ...
        },
        {
          ...
          answer: "Exit the entire loop or switch statement."
        },
        {
        ...
        },
        {
          ...
          answer: "It can have rows of different lengths."
        },
        {
      ...
      "Session 4": [
        {
          ...
          answer: "A special method that has the same name as the class and is used to initialize objects."
        },
        {
        ...
        },
        {
          ...
          answer: "Without creating an instance of the class."
        },
        {
          ...
          answer: "Creating multiple methods with the same name but different signatures."
        },
        {
      ...
      "Session 5": [
        {
          ...
          answer: "To create a new class from an existing class, promoting code reusability."
        },
        {
        ...
        },
        {
          ...
          answer: "Invoke derived class methods through a base class reference."
        },
        {
          ...
          answer: "Call the constructor of the base class."
        }
      ],
      "Session 6": [
        {
          ...
          answer: "Can contain both implemented and abstract methods."
        },
        {
          ...
          answer: "To group related functionalities that must be implemented by a class."
        },
        {
        ...
        },
        {
          ...
          answer: "An abstract class can have constructors; an interface cannot."
        },
        {
          ...
          answer: "Check the compatibility of types."
        }
      ],
      "Session 7": [
        {
          ...
          answer: "To provide a secure way to access and modify private fields."
        },
        {
          ...
          answer: "Is created by the compiler, which generates the backing field and accessors."
        },
        {
          ...
          answer: "It provides built-in functionality for value-based equality."
        },
        {
          ...
          answer: "Treated as an array, using an index to access its elements."
        },
        {
          ...
          answer: "Make a property writable only in the constructor."
        }
      ],
      "Session 8": [
        {
          ...
          answer: "To organize classes and prevent name conflicts."
        },
        {
        ...
        },
        {
          ...
          answer: "Execute code regardless of whether an exception occurs."
        },
        {
          ...
          answer: "System.DivideByZeroException"
        },
        {
          ...
          answer: "Programmatically raise an exception."
        }
      ],
      "Session 9": [
        {
        ...
        },
        {
          ...
          answer: "A delegate that can reference and invoke multiple methods."
        },
        {
          ...
          answer: "An event is a delegate instance that can only be invoked from within the class it is declared in."
        },
        {
        ...
        },
        {
          ...
          answer: "Creating type-safe collections."
        }
      ],
      "Session 10": [
        {
          ...
          answer: "They allow for code reusability with different data types while ensuring type safety."
        },
        {
        ...
        },
        {
          ...
          answer: "It returns a value and maintains the state of the iterator for the next call."
        },
        {
          ...
          answer: "Including a type parameter list in its declaration."
        },
        {
          ...
          answer: "Iterating over a collection."
        }
      ],
      "Session 11": [
        {
          ...
          answer: "A top-level window that serves as the primary container for controls."
        },
        {
        ...
        },
        {
          ...
          answer: "To prevent SQL injection attacks and make queries more secure."
        }
      ],
      "Session 12": [
        {
        ...
        },
        {
          ...
          answer: "To split the definition of a class, struct, or interface across multiple files."
        },
        {
          ...
          answer: "Adding a ? after the value type."
        },
        {
          ...
          answer: "Representing an asynchronous operation."
        },
        {
          ...
          answer: "Synchronize access to a block of code, allowing only one thread at a time."
        }
      ]
    },
    "Material UI": {
      "Session 1": [
        ...
        },
        {
          ...
          answer: "Designing the point of interaction between a user and a digital product."
        },
        {
        ...
        },
        {
          ...
          answer: "An implementation of Google's Material Design specification."
        },
        {
      ...
      "Session 2": [
        {
          ...
          answer: "A piece of data used to store style values for consistency between design and code."
        },
        {
          ...
          answer: "UI and UX design and collaboration."
        },
        {
        ...
        },
        {
          ...
          answer: "Allowing users to keep track of their location within a program or website."
        },
        {
        ...
        },
        {
          ...
          answer: "UX is about usability, UI is about beauty."
        },
        {
      ...
      "Session 3": [
        {
          ...
          answer: "Text styles with specific roles."
        },
        {
        ...
        },
        {
          ...
          answer: "The Responsive Grid System"
        },
        {
          ...
          answer: "They make designs look appealing and help create depth."
        },
        {
    ...
    "SQL Server - The Definitive Guide": {
      "Session 1": [
        {
          ...
          answer: "To enable users to enter, store, and manage data"
        },
        {
        ...
        },
        {
          ...
          answer: "A row or record in a relation"
        },
        {
        ...
        },
        {
          ...
          answer: "Each row/column intersection represents multiple data values."
        }
      ],
      "Session 2": [
        {
          ...
          answer: "A real-world object that exists physically"
        },
        {
        ...
        },
        {
          ...
          answer: "Reduce data redundancy and anomalies"
        },
        {
      ...
      "Session 4": [
        ...
        },
        {
          ...
          answer: "Variable-length non-Unicode character data"
        },
        {
      ...
      "Session 5": [
        ...
        },
        {
          ...
          answer: "To record all transactions and database modifications"
        },
        {
          ...
          answer: "A read-only, static view of a database at a point in time"
        },
        {
      ...
      "Session 6": [
        {
          ...
          answer: "Create a column with auto-generated sequential values."
        },
        {
        ...
        },
        {
          ...
          answer: "Enforce referential integrity between tables."
        },
        {
      ...
      "Session 7": [
        {
          ...
          answer: "Cloud-based relational database service"
        },
        {
        ...
        },
        {
          ...
          answer: "Does not support the USE statement to switch databases."
        }
      ],
      "Session 8": [
        {
        ...
        },
        {
          ...
          answer: "Eliminate duplicate rows from the resultset."
        },
        {
          ...
          answer: "Specifies the sort order of the resultset."
        },
        {
          ...
          answer: "An XML instance that has an associated XML schema."
        }
      ],
      "Session 9": [
        {
          ...
          answer: "Only the rows where there is a match in both tables."
        },
        {
        ...
        },
        {
          ...
          answer: "Filter groups after the GROUP BY clause has been applied."
        },
        {
          ...
          answer: "Transform data from a row-based to a column-based orientation."
        }
      ],
      "Session 10": [
        {
          ...
          answer: "A virtual table made up of data from one or more tables."
        },
        {
          ...
          answer: "System Stored Procedure"
        },
        {
          ...
          answer: "Server and database state information."
        }
      ],
      "Session 11": [
        {
          ...
          answer: "To speed up data retrieval from a table."
        },
        {
        ...
        },
        {
          ...
          answer: "Data warehousing and read-only queries"
        }
      ],
      "Session 12": [
        {
      ...
      "Session 13": [
        ...
        },
        {
          ...
          answer: "Window or partition within a query resultset."
        }
      ],
      "Session 14": [
        {
    ...
    "Web Programming using ASP.NET CORE and MVC": {
      "Session 1": [
        {
          ...
          answer: "Active Server Pages (ASP)"
        },
        {
        ...
        },
        {
          ...
          answer: "Support for self-hosting and a modular HTTP request pipeline"
        }
      ],
      "Session 2": [
        {
      ...
      "Session 3": [
        ...
        },
        {
          ...
          answer: "An Object-Relational Mapping (ORM) tool"
        },
        {
      ...
      "Session 4": [
        ...
        },
        {
          ...
          answer: "To map incoming HTTP requests to executable endpoints (controllers/actions)"
        },
        {
          ...
          answer: "Most resources are loaded once, and only data is transmitted as needed."
        }
      ],
      "Session 5": [
        {
          ...
          answer: "View-based authorization"
        },
        {
          ...
          answer: "Map an action method to a different name."
        },
        {
        ...
        },
        {
          ...
          answer: "A Partial View does not include a layout page."
        }
      ],
      "Session 6": [
        {
        ...
        },
        {
          ...
          answer: "REST supports multiple data formats, while SOAP primarily uses XML."
        },
        {
      ...
      "Session 7": [
        {
          ...
          answer: "Server-side markup language for embedding code into Web pages"
        },
        {
        ...
        },
        {
          ...
          answer: "To manage memory allocation and reclaim unused memory"
        }
      ],
      "Session 8": [
        {
          ...
          answer: "It includes a Command Line Interface (CLI)."
        },
        {
        ...
        },
        {
          ...
          answer: "Clients can request exactly the data they need in a single query."
        }
      ],
      "Session 9": [
        {
          ...
          answer: "Inversion of Control (IoC) and Dependency Inversion Principle (DIP)"
        },
        {
        ...
        },
        {
          ...
          answer: "Easy maintenance due to logical separation and loose coupling"
        }
      ],
      "Session 10": [
        {
          ...
          answer: "Customize database mappings and override default conventions."
        },
        {
        ...
        },
        {
          ...
          answer: "Object-to-object mapping."
        }
      ],
      "Session 11": [
        {
      ...
      "Session 12": [
        {
          ...
          answer: "The Business Logic Layer and the Data Access Layer"
        },
        {
          ...
          answer: "Combines multiple CRUD operations into a single transaction."
        },
        {
          ...
          answer: "It ensures data integrity by committing all changes together or rolling them back."
        }
      ],
      "Session 13": [
        {
        ...
        },
        {
          ...
          answer: "Maintain user-specific data across multiple requests within the same session."
        }
      ],
      "Session 14": [
        {
        ...
        },
        {
          ...
          answer: ".NET Core Hosting Bundle"
        },
        {
