const semester3Data = 
{
  ...
  "books": [
    {
      "id": "sql_server___the_definitive_guide",
      ...
      "mcqs": [
        {
          ...
          "options": [
            "To generate complex graphical reports",
            "To enable users to enter, store, and manage data",
            "To replace all file-based systems",
        ...
        },
        {
          ...
          "options": [
            ...
            "Unanticipated queries are easy to handle"
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "Each row/column intersection represents multiple data values.",
        ...
        },
        {
          ...
          "options": [
            ...
            "A real-world object that exists physically",
            "A database schema",
            "A type of SQL query"
          ],
          "correctAnswer": 1
        ...
        },
        {
          ...
          "options": [
            "Speed up all query operations",
            "Reduce data redundancy and anomalies",
            "Create more tables in the database",
            "Make the database smaller in physical size"
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "To record all transactions and database modifications",
            "To act as a backup of the primary data file"
          ],
          "correctAnswer": 2
        },
        {
          ...
          "options": [
            ...
            "A read-only, static view of a database at a point in time",
            "A copy of the database on a different server",
        ...
        },
        {
          ...
          "options": [
            "Create a column that allows NULL values.",
            "Create a column with a default value.",
            "Create a column with auto-generated sequential values.",
            "Create a column that is a foreign key."
          ],
          "correctAnswer": 2
        },
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "Ensure a column does not contain NULL values."
          ],
          "correctAnswer": 2
        },
        {
        ...
        },
        {
          ...
          "options": [
            "On-premises version of SQL Server",
            "Cloud-based relational database service",
            "Open-source database competitor",
        ...
        },
        {
          ...
          "options": [
            ...
            "Does not support the USE statement to switch databases.",
            "Provides more tools for monitoring."
          ],
          "correctAnswer": 2
        },
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "Eliminate duplicate rows from the resultset.",
        ...
        },
        {
          ...
          "options": [
            ...
            "Filters the groups.",
            "Specifies the sort order of the resultset.",
        ...
        },
        {
          ...
          "options": [
            "An XML instance stored in a varchar column.",
            "An XML instance that has an associated XML schema.",
            "An XML instance that is unvalidated.",
            "An XML instance used only for output."
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "Filter groups after the GROUP BY clause has been applied.",
        ...
        },
        {
          ...
          "options": [
            "Transform data from a row-based to a column-based orientation.",
            "Combine multiple rows into a single row.",
            "Create a hierarchical view of data.",
        ...
        },
        {
          ...
          "options": [
            ...
            "A virtual table made up of data from one or more tables.",
            "A stored procedure that returns a resultset.",
            "A type of index."
          ],
          "correctAnswer": 1
        },
        ...
        },
        {
          ...
          "options": [
            ...
            "Server and database state information.",
        ...
        },
        {
          ...
          "options": [
            "OLTP (Online Transaction Processing)",
            "Data warehousing and read-only queries",
        ...
        },
        {
          ...
          "options": [
            ...
            "Window or partition within a query resultset.",
    ...
    {
      "id": "developing_applications_with_csharp",
      "title": "Developing Applications with Csharp",
      "author": "Course Material",
      "mcqs": [
        {
          ...
          "options": [
            ...
            "A platform created by Microsoft for building applications",
        ...
        },
        {
          ...
          "options": [
            "To provide a set of base classes for I/O and string manipulation",
            "To act as the output code when a .NET language is compiled",
            "To enable interoperability of dynamic languages like Python",
            "To define the rules for cross-language integration"
          ],
          "correctAnswer": 1
        },
        {
          ...
          "options": [
            "It is the last version of the .NET Framework.",
            "It only runs on Windows.",
            "It integrates tools like ASP.NET Core and Entity Framework Core.",
            "It does not support C# 10.0."
          ],
          "correctAnswer": 2
        },
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "To declare a variable with a fixed, unchangeable value.",
            "To create a variable that is only accessible within a method.",
        ...
        },
        {
          ...
          "options": [
            "To force every program to have a Main method.",
            "To make programs simpler by omitting the Main method boilerplate.",
            "To allow multiple entry points in a program.",
            "To improve the performance of console applications."
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            "Skip the current iteration of a loop and continue with the next.",
            "Exit the entire loop or switch statement.",
        ...
        },
        {
          ...
          "options": [
            ...
            "1",
            "-1",
            "It can be specified by the programmer."
          ],
          "correctAnswer": 0
        },
        {
          ...
          "options": [
            "It must be single-dimensional.",
            "It can have rows of different lengths.",
        ...
        },
        {
          ...
          "options": [
            "A special method that has the same name as the class and is used to initialize objects.",
            "A method that is used to destroy objects and free memory.",
            "A method that is always declared as static.",
            "A method that can only be called from a static context."
          ],
          "correctAnswer": 0
        },
        {
        ...
        },
        {
          ...
          "options": [
            "Only using an object of the class.",
            "Without creating an instance of the class.",
            "Only from within another static method.",
        ...
        },
        {
          ...
          "options": [
            ...
            "Using the override keyword in a method definition."
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "To create a new class from an existing class, promoting code reusability.",
        ...
        },
        {
          ...
          "options": [
            ...
            "Invoke derived class methods through a base class reference.",
            "Inherit from multiple base classes.",
            "Make all methods in a class static."
          ],
          "correctAnswer": 1
        },
        {
          ...
          "options": [
            ...
            "Hide a member of the base class.",
        ...
        },
        {
          ...
          "options": [
            "Cannot have any abstract methods.",
        ...
        },
        {
          ...
          "options": [
            "To provide a complete implementation for a set of methods.",
            "To group related functionalities that must be implemented by a class.",
            "To create a sealed class.",
            "To allow multiple inheritances of implementation."
          ],
          "correctAnswer": 1
        },
        {
          ...
          "options": [
            ...
            "Multiple interfaces.",
            "Both multiple abstract classes and multiple interfaces."
          ],
          "correctAnswer": 2
        },
        {
          ...
          "options": [
            ...
            "An interface can be sealed; an abstract class cannot."
          ],
          "correctAnswer": 0
        },
        {
        ...
        },
        {
          ...
          "options": [
            "To replace all methods in a class.",
            "To provide a secure way to access and modify private fields.",
            "To create a new data type.",
            "To execute a block of code asynchronously."
          ],
          "correctAnswer": 1
        },
        {
          ...
          "options": [
            "Must explicitly define a private backing field.",
            "Is declared without get and set accessors.",
            "Is created by the compiler, which generates the backing field and accessors.",
        ...
        },
        {
          ...
          "options": [
            ...
            "It provides built-in functionality for value-based equality.",
            "It cannot be used in inheritance hierarchies.",
            "It is primarily used for defining static classes."
          ],
          "correctAnswer": 1
        },
        {
          ...
          "options": [
            "Treated as an array, using an index to access its elements.",
            "Converted into a primitive data type.",
            "Made immutable.",
        ...
        },
        {
          ...
          "options": [
            "Make a property writable only in the constructor.",
            "Create a property that can only be read.",
            "Make a property that can be set multiple times after object creation.",
        ...
        },
        {
          ...
          "options": [
            ...
            "To organize classes and prevent name conflicts.",
        ...
        },
        {
          ...
          "options": [
            "A delegate that can only reference one method.",
            "A delegate that can reference and invoke multiple methods.",
            "A delegate that is used only for static methods.",
            "A delegate that cannot return a value."
          ],
          "correctAnswer": 1
        },
        {
          ...
          "options": [
            "An event is a delegate instance that can only be invoked from within the class it is declared in.",
            "A delegate is a special type of event.",
            "An event cannot have multiple subscribers; a delegate can.",
        ...
        },
        {
          ...
          "options": [
            "They make code run slower but more secure.",
            "They allow for code reusability with different data types while ensuring type safety.",
            "They force all data to be of the object type.",
            "They are only useful for collection classes."
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "It returns a value and maintains the state of the iterator for the next call.",
        ...
        },
        {
          ...
          "options": [
            ...
            "Including a type parameter list in its declaration.",
            "Inheriting from a generic class.",
            "Being declared inside a generic class."
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            "A database table.",
            "A top-level window that serves as the primary container for controls.",
        ...
        },
        {
          ...
          "options": [
            ...
            "To prevent SQL injection attacks and make queries more secure.",
            "To allow the command to execute multiple SQL statements at once.",
            "To automatically open and close the database connection."
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "To split the definition of a class, struct, or interface across multiple files.",
        ...
        },
        {
          ...
          "options": [
            "Create a new thread.",
            "Synchronize access to a block of code, allowing only one thread at a time.",
            "Terminate a running thread.",
            "Improve the performance of a single-threaded application."
          ],
          "correctAnswer": 1
        }
      ]
    ...
    {
      "id": "web_programming_using_aspnet_core_and_mvc",
      "title": "Web Programming using ASPNET CORE and MVC",
      "author": "Course Material",
      "mcqs": [
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "It uses Web Forms as the primary UI model.",
            "It relies on the System.Web assembly."
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            "Tight coupling with Internet Information Services (IIS)",
            "A closed-source environment",
            "Support for self-hosting and a modular HTTP request pipeline",
            "Inability to run on .NET Framework"
          ],
          "correctAnswer": 2
        },
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "To map incoming HTTP requests to executable endpoints (controllers/actions)",
        ...
        },
        {
          ...
          "options": [
            "It requires a full page reload for every user interaction.",
            "Most resources are loaded once, and only data is transmitted as needed.",
            "It cannot be built using ASP.NET Core.",
            "It has no need for client-side scripting."
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            "Restrict an action to POST requests.",
            "Map an action method to a different name.",
            "Make a method non-callable as an action.",
            "Define a custom route template."
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            "A Partial View includes a layout page.",
            "A Partial View does not include a layout page.",
            "A Partial View cannot contain HTML.",
            "A Partial View is only for data models."
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            "SOAP supports multiple data formats, while REST only supports XML.",
            "REST supports multiple data formats, while SOAP primarily uses XML.",
            "REST is a protocol, while SOAP is an architectural style.",
            "SOAP is generally considered faster and easier than REST."
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "Server-side markup language for embedding code into Web pages",
        ...
        },
        {
          ...
          "options": [
            ...
            "To manage memory allocation and reclaim unused memory",
        ...
        },
        {
          ...
          "options": [
            "It is Windows-only.",
            "It includes a Command Line Interface (CLI).",
            "It cannot be used to build RESTful APIs.",
        ...
        },
        {
          ...
          "options": [
            ...
            "Clients can request exactly the data they need in a single query.",
            "The server always defines the fixed response structure.",
            "It requires versioning for every change."
          ],
          "correctAnswer": 1
        },
        {
          ...
          "options": [
            ...
            "Inversion of Control (IoC) and Dependency Inversion Principle (DIP)",
        ...
        },
        {
          ...
          "options": [
            ...
            "Concrete classes should never be used."
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "Easy maintenance due to logical separation and loose coupling",
        ...
        },
        {
          ...
          "options": [
            ...
            "Customize database mappings and override default conventions.",
        ...
        },
        {
          ...
          "options": [
            "Stateful, requiring server-side sessions.",
            "Stateless and scalable.",
            "Only usable with SOAP services.",
            "Dependent on storing session data on the server."
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "Combines multiple CRUD operations into a single transaction.",
            "Is a client-side validation technique.",
        ...
        },
        {
          ...
          "options": [
            ...
            "It ensures data integrity by committing all changes together or rolling them back.",
            "It blocks database tables until all changes are committed.",
            "It tightly couples the data layer with the business layer."
          ],
          "correctAnswer": 1
        },
        {
    ...
    {
      "id": "building_angular_applications_with_typescript",
      "title": "Building Angular Applications with TypeScript",
      "author": "Course Material",
      "mcqs": [
        {
        ...
        },
        {
          ...
          "options": [
            "Store only keys, not key-value pairs.",
            "Map keys to values without the disadvantages of using Objects.",
            "Create a new array by applying a function to each element.",
            "Define a new class structure."
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            "Excellent SEO support out-of-the-box",
            "Poor compatibility with legacy browsers",
            "Inability to build mobile apps",
        ...
        },
        {
          ...
          "options": [
            ...
            "Service, Module, Directive",
            "Pipe, Guard, Interface"
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "Attribute Binding and Class Binding"
          ],
          "correctAnswer": 2
        },
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "To loop over an iterable and add elements to the DOM",
        ...
        },
        {
          ...
          "options": [
            ...
            "To group elements without adding an extra element to the DOM",
            "To define a template for a component"
          ],
          "correctAnswer": 2
        },
        {
          ...
          "options": [
            "To make code more flexible, testable, and mutable",
            "To improve SEO",
            "To handle CSS animations",
            "To create direct DOM manipulations"
          ],
          "correctAnswer": 0
        },
        {
        ...
        },
        {
          ...
          "options": [
            "To validate forms",
            "To create service instances and inject them into classes",
        ...
        },
        {
          ...
          "options": [
            "A Promise can handle multiple values over time, while an Observable cannot.",
            "An Observable can handle multiple values over time, while a Promise provides a single value.",
            "They are identical and can be used interchangeably.",
            "A Promise is used for CSS, while an Observable is for HTTP requests."
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            "To pass optional parameters like page numbers",
            "As dynamic, essential parts of the route definition",
        ...
        },
        {
          ...
          "options": [
            ...
            "A UI component library following Google's Material Design",
            "A testing framework",
    ...
    },
    {
      ...
      "mcqs": [
        ...
        },
        {
          ...
          "options": [
            "Writing backend code for an application.",
            "Managing the database of a website.",
            "Designing the point of interaction between a user and a digital product.",
        ...
        },
        {
          ...
          "options": [
            "A programming language.",
            "An implementation of Google's Material Design specification.",
        ...
        },
        {
          ...
          "options": [
            "A physical key used for security.",
            "A piece of data used to store style values for consistency between design and code.",
        ...
        },
        {
          ...
          "options": [
            "Database management.",
            "UI and UX design and collaboration.",
        ...
        },
        {
          ...
          "options": [
            "Playing audio files.",
            "Allowing users to keep track of their location within a program or website.",
        ...
        },
        {
          ...
          "options": [
            "UX is about beauty, UI is about usability.",
            "UX is specific to digital interfaces, UI is broad.",
            "UX is about usability, UI is about beauty.",
            "UX is looks-driven, UI is data-driven."
          ],
          "correctAnswer": 2
        },
        {
        ...
        },
        {
          ...
          "options": [
            "Color palettes only.",
            "Text styles with specific roles.",
            "Shadow effects.",
        ...
        },
        {
          ...
          "options": [
            ...
            "They reduce the file size of the design.",
            "They make designs look appealing and help create depth.",
            "They are used to encrypt user interface elements."
          ],
          "correctAnswer": 2
        },
        {
