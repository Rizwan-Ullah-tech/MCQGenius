const semester2Data = 
{
  ...
  "books": [
    {
      "id": "architecting_web_applications_using_php",
      "title": "Architecting Web Applications using PHP",
      ...
      "mcqs": [
        ...
        },
        {
          ...
          "options": [
            "constant(\"SITE_NAME\", \"MySite\", true);",
            "define(\"SITE_NAME\", \"MySite\", false);",
            "define(\"SITE_NAME\", \"MySite\", true);",
            "const SITE_NAME = \"MySite\" case_insensitive;"
          ],
          "correctAnswer": 2
        },
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "Jump out of a loop or switch statement.",
            "Pause the execution of a loop."
          ],
          "correctAnswer": 2
        },
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "Preventing Cross-Site Scripting (XSS) attacks by converting special characters to HTML entities.",
            "Sending emails."
          ],
          "correctAnswer": 2
        },
        ...
        },
        {
          ...
          "options": [
            "Perform a pattern match using regular expressions.",
            "Print a string to the browser.",
            "Merge two arrays.",
        ...
        },
        {
          ...
          "options": [
            ...
            "Sessions can only store strings, while cookies can store arrays."
          ],
          "correctAnswer": 2
        },
        {
        ...
        },
        {
          ...
          "options": [
            "session_unset() only",
            "session_destroy() only",
            "Both session_unset() and session_destroy()",
            "unset($_SESSION)"
          ],
          "correctAnswer": 2
        }
    ...
    {
      "id": "build_and_manage_websites_using_cms",
      "title": "Build and Manage Websites using CMS",
      "author": "Course Material",
      "mcqs": [
        {
          "question": "What is the primary purpose of a Content Management System (CMS)?",
          "options": [
            "To write custom code for websites",
            "To create, manage, and modify digital content without extensive technical knowledge",
            "To replace web developers entirely",
            "To only manage e-commerce transactions"
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "To control when content is published or unpublished",
        ...
        },
        {
          ...
          "options": [
            ...
            "To determine the website's appearance, layout, and user experience",
        ...
        },
        {
          ...
          "options": [
            "The WordPress Theme Marketplace",
            "The WordPress Theme Repository",
            "A third-party developer's website",
        ...
        },
        {
          ...
          "options": [
            ...
            "To add specific features or functions without custom coding",
            "To manage the website's database",
            "To replace the core WordPress software"
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "In widget-ready areas like sidebars, footers, and headers",
        ...
        },
        {
          ...
          "options": [
            ...
            "Posts are for dynamic content like blogs, Pages are for static content like \"About Us\".",
            "Pages can have categories, Posts cannot.",
            "Posts are hierarchical, Pages are not."
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "Using the YouTube block in the Block Editor",
            "Copying and pasting the video file",
        ...
        },
        {
          ...
          "options": [
            ...
            "It adapts its layout and content to fit different screen sizes and devices.",
            "It loads faster on mobile data.",
            "It only uses mobile-friendly colors."
          ],
          "correctAnswer": 1
        },
        {
          ...
          "options": [
            "To automatically fix website errors",
            "To track and report website traffic and user behavior",
            "To replace the WordPress dashboard",
        ...
        },
        {
          ...
          "options": [
            ...
            "Compressing images and leveraging modern formats",
            "Storing all images in a separate database"
          ],
          "correctAnswer": 2
        },
        {
        ...
        },
        {
          ...
          "options": [
            "To replace the entire website theme",
            "To automate tasks and enhance content creation",
            "To physically host the website server",
            "To manually write all code"
          ],
          "correctAnswer": 1
        },
        {
          ...
          "options": [
            "A special type of postal service for websites",
            "A default post category like \"Blog\"",
            "A way to create content types beyond default posts and pages (e.g., Products, Portfolios)",
            "A method for sending email newsletters"
          ],
          "correctAnswer": 2
        },
        {
          ...
          "options": [
            "To increase its Google search ranking",
            "To restore the website in case of an error or cyberattack",
            "To make the website load faster",
            "To change the website's theme automatically"
          ],
          "correctAnswer": 1
        },
        {
    ...
    {
      "id": "crafting_efficient_code_with_javascript",
      "title": "Crafting Efficient Code with JavaScript",
      "author": "Course Material",
      "mcqs": [
        {
          "question": "What is the primary purpose of Object-Oriented Programming (OOP) in JavaScript?",
          "options": [
            "To only manage asynchronous operations",
            "To handle complexity by modeling real-world entities as objects",
            "To replace all functional programming patterns",
        ...
        },
        {
          ...
          "options": [
            ...
            "To secure class properties through encapsulation",
            "To allow global access to properties",
        ...
        },
        {
          ...
          "options": [
            "They make JavaScript run on servers",
            "They divide functionality into self-contained files for better organization",
            "They automatically minify the code",
            "They convert JavaScript into Python"
          ],
          "correctAnswer": 1
        },
        {
          ...
          "options": [
            "By loading all modules at startup",
            "By loading modules only when required, improving initial load times",
            "By deleting unused modules",
            "By converting modules into images"
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "Handling string manipulation, validation, and pattern matching",
        ...
        },
        {
          ...
          "options": [
            ...
            "Quickly extract values from objects based on key names",
        ...
        },
        {
          ...
          "options": [
            "?? considers empty strings, || does not.",
            "?? assigns default values for null or undefined, while || also considers other falsy values like 0 or ''.",
        ...
        },
        {
          ...
          "options": [
            "It makes a property mandatory.",
            "It prevents errors by returning undefined if a part of a nested property chain is missing.",
            "It chains multiple functions together.",
            "It converts optional properties to required ones."
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            "To style web pages",
            "To execute heavy computations in background threads, preserving UI responsiveness",
        ...
        },
        {
          ...
          "options": [
            "Code Splitting",
            "Inlining all CSS",
            "Using more synchronous code",
            "Avoiding all JavaScript"
          ],
          "correctAnswer": 0
        },
        {
          ...
          "options": [
            ...
            "To convert modern JavaScript (ES6+) into backward-compatible versions (like ES5)",
        ...
        },
        {
          ...
          "options": [
            ...
            "Cross-browser support for modern JavaScript features",
        ...
        },
        {
          ...
          "options": [
            "By loading all modules during the initial page load",
            "By using dynamic imports to load JavaScript modules on demand",
            "By caching all modules in the browser",
            "By preventing any modules from loading"
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            "To analyze network speed",
            "To identify memory leaks and objects not released from memory",
        ...
        },
        {
          ...
          "options": [
            "Tracking the execution flow of callbacks and promises",
            "The lack of console.log statements",
            "Synchronous code being too fast",
            "Overuse of comments"
          ],
          "correctAnswer": 0
        },
        ...
        },
        {
          ...
          "options": [
            "It uses a heavy runtime library.",
            "It is a compiler that pre-compiles components into optimized JavaScript.",
            "It requires a virtual DOM for all operations.",
            "It only works for backend development."
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "It delivers pre-rendered content for faster loading and better SEO.",
            "It only works for static sites.",
            "It removes all JavaScript from the client."
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "They load modules only when needed, improving initial load time.",
            "They delete old modules automatically.",
            "They convert all code to TypeScript."
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            "Using very small fonts in the design",
            "An architectural approach that splits a large app into smaller, independently developed frontend modules",
            "A new JavaScript data type",
            "A tool for minifying HTML"
          ],
          "correctAnswer": 1
        }
      ]
    ...
    {
      "id": "data_processing_with_xml_and_json",
      "title": "Data Processing with XML and JSON",
      "author": "Course Material",
      "mcqs": [
        {
        ...
        },
        {
          ...
          "options": [
            "It combines data and presentation.",
        ...
        },
        {
          ...
          "options": [
            "To make the XML file smaller",
            "To ensure the document conforms to a schema or DTD",
            "To convert XML to JSON",
            "To encrypt the XML data"
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            "To display XML in a browser",
            "To read, examine, and understand XML documents",
            "To convert XML to HTML",
            "To validate XML against a JSON schema"
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            "To make the document run faster",
            "To prevent naming conflicts and uniquely identify elements",
        ...
        },
        {
          ...
          "options": [
            ...
            "Navigating and selecting elements from an XML document",
        ...
        },
        {
          ...
          "options": [
            ...
            "It cannot use conditional processing.",
            "It only outputs other XML documents."
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            "JSON is document-oriented, XML is data-oriented.",
            "JSON is more verbose than XML.",
            "JSON is data-oriented, XML is document-oriented.",
            "JSON has native support for comments."
          ],
          "correctAnswer": 2
        },
        {
        ...
        },
        {
          ...
          "options": [
            "To execute JSON code",
            "To annotate and validate the structure and content of JSON data",
            "To minify JSON files",
        ...
        },
        {
          ...
          "options": [
            ...
            "Supplementary information about the data, like authorship or timestamps",
            "The execution logic",
            "Comments for the parser"
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            "It is a complex and verbose format.",
            "It is language-independent and human-readable.",
            "It can only be used with JavaScript.",
            "It requires special software to parse."
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            "To block all requests between different origins",
            "To allow Web browsers to securely access resources from different origins",
            "To make websites load faster",
            "To replace HTTP with a new protocol"
          ],
          "correctAnswer": 1
        },
        {
    ...
    {
      "id": "fundamentals_of_millennial_entrepreneurship",
      "title": "Fundamentals of Millennial Entrepreneurship",
      "author": "Course Material",
      "mcqs": [
        {
          ...
          "options": [
            ...
            "A person who creates, establishes, and operates a business venture, bearing most of the risks",
            "An employee who manages a company's department",
            "A person who only comes up with ideas but does not execute them"
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "Decision-making has to be a joint process.",
            "Business activities can be split and assigned.",
        ...
        },
        {
          ...
          "options": [
            ...
            "Entrepreneurs earn lots of money right from the start.",
            "Delegation is crucial for success.",
        ...
        },
        {
          ...
          "options": [
            "Someone born on or after 1981",
            "Someone born before 1980",
            "Someone born after 2000",
            "Someone born between 1965 and 1979"
          ],
          "correctAnswer": 0
        },
        {
          ...
          "options": [
            "A group of people working independently on different goals",
            "A single person managing a project",
        ...
        },
        {
          ...
          "options": [
            "The process of hiring digital marketers",
            "The process of using digital technology to upgrade and improve all areas of the business",
            "The process of converting digital files to paper",
            "The process of selling products online only"
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            "Full-time employment with a single company",
            "Contract-based self-employment for short and long-term projects",
        ...
        },
        {
          ...
          "options": [
            "A freelancer employs numerous people.",
            "An entrepreneur typically works solo.",
            "A freelancer gets paid for work done and often runs a one-person business.",
            "An entrepreneur does not take financial risks."
          ],
          "correctAnswer": 2
        },
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "Employing a team of assistants",
            "Required educational qualification and skill set",
            "Guarantee of a fixed monthly income"
          ],
          "correctAnswer": 2
        },
        {
          ...
          "options": [
            ...
            "Define goals and work requirements",
        ...
        },
        {
          ...
          "options": [
            ...
            "By asking for business referrals",
            "By not having a portfolio"
          ],
          "correctAnswer": 2
        },
        {
    ...
    {
      "id": "laravel_framework_for_web_applications",
      "title": "Laravel Framework for Web Applications",
      "author": "Course Material",
      "mcqs": [
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "To act as a dependency management tool for PHP",
            "To provide a command-line interface for Git",
        ...
        },
        {
          ...
          "options": [
            "To develop, test, and deploy applications rapidly and efficiently.",
            "To replace the need for a database.",
            "To write low-level PHP code.",
        ...
        },
        {
          ...
          "options": [
            "Writing more configuration files",
            "Predicting dependencies and automating configuration tasks",
        ...
        },
        {
          ...
          "options": [
            ...
            "To act as a version control system for your database schema.",
        ...
        },
        {
          ...
          "options": [
            "php artisan model:make Employee",
            "php artisan make:model Employee",
            "php artisan create:model Employee",
            "php artisan generate:model Employee"
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            "A hard delete removes records from the UI, a soft delete removes them from the database.",
            "A hard delete removes records permanently from the database, a soft delete only marks them as deleted.",
            "There is no difference.",
            "A soft delete is faster than a hard delete."
          ],
          "correctAnswer": 1
        },
        {
          ...
          "options": [
            ...
            "It helps in organizing the application and separating concerns.",
            "It is required for using Eloquent ORM.",
            "It automatically creates views."
          ],
          "correctAnswer": 1
        },
        {
          ...
          "options": [
            "php artisan controller:make EmployeeController",
            "php artisan make:controller EmployeeController --resource",
            "php artisan generate:resource EmployeeController",
            "php artisan create:resource-controller EmployeeController"
          ],
          "correctAnswer": 1
        },
        {
    ...
    {
      "id": "practical_mysql",
      "title": "Practical MySQL",
      "author": "Course Material",
      "mcqs": [
        {
          "question": "Which of the following is a key difference between DBMS and RDBMS?",
          "options": [
            "DBMS supports distributed databases, while RDBMS does not.",
            "DBMS allows normalization, while RDBMS does not.",
            "Data is stored in a hierarchical form in DBMS and in table format in RDBMS.",
            "RDBMS has no security for data, unlike DBMS."
          ],
          "correctAnswer": 2
        },
        {
        ...
        },
        {
          ...
          "options": [
            "Operating Systems",
            "Web Applications and Content Management Systems (like WordPress)",
        ...
        },
        {
          ...
          "options": [
            "Matched, Not Matched, Not Matched by Source",
            "Joined, Filtered, Sorted",
            "Selected, Inserted, Updated",
        ...
        },
        {
          ...
          "options": [
            "Sorts the results",
            "Fetches unique values from a table",
            "Groups the results",
            "Joins two tables"
          ],
          "correctAnswer": 1
        ...
        },
        {
          ...
          "options": [
            "INSERT DATA INTO table_name VALUES (...);",
        ...
        },
        {
          ...
          "options": [
            ...
            "To combine and retrieve data from more than one table",
        ...
        },
        {
          ...
          "options": [
            ...
            "A join that uses the SELF keyword",
            "A join that always returns an empty set"
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "UNION only works with two tables, UNION ALL works with many.",
            "UNION is a DDL command, UNION ALL is a DML command."
          ],
          "correctAnswer": 1
        },
        {
          ...
          "options": [
            ...
            "A query that creates a sub-table",
            "A query used only with the UPDATE command"
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            ...
            "The outer query must be executed first.",
        ...
        },
        {
          ...
          "options": [
            "DELETE FUNCTION getSalary;",
            "DROP FUNCTION getSalary;",
            "REMOVE FUNCTION getSalary;",
        ...
        },
        {
          ...
          "options": [
            ...
            "When the column has many unique values",
        ...
        },
        {
          ...
          "options": [
            "The process of backing up data to a tape drive",
            "The process of copying data from a source server to one or more replica servers",
            "The process of partitioning a large table",
        ...
        },
        {
          ...
          "options": [
            "It generates less data in the binary log.",
            "It is less sensitive to non-deterministic queries.",
            "It is easier to audit.",
            "It uses less network traffic."
          ],
          "correctAnswer": 1
        },
        {
          ...
          "options": [
            "The ability to recover from hardware failure",
            "The capability to extend the database and load across several servers",
            "The process of compressing data",
            "The method for securing user passwords"
          ],
          "correctAnswer": 1
        },
        {
          ...
          "options": [
            "A signal to check if the replica server is still functional",
            "A method to speed up replication",
            "A type of replication error",
            "A backup of the replication configuration"
          ],
          "correctAnswer": 0
        },
        {
          ...
          "options": [
            "The process of dividing a table's rows into separate tables in different locations",
            "The process of creating database backups",
            "The process of joining multiple tables",
        ...
        },
        {
          ...
          "options": [
            "Adding new partitions to a table",
            "The technique of not scanning partitions that do not contain matching values",
        ...
        },
        {
          ...
          "options": [
            "Delete a table",
            "Show how MySQL executes a SQL statement",
        ...
        },
        {
          ...
          "options": [
            ...
            "Makes queries run slower",
            "Reduces the time and computing power needed",
        ...
        },
        {
          ...
          "options": [
            "Deleting the query",
            "Breaking a large, complex query into smaller parts",
            "Encrypting the query",
            "Changing the query's syntax"
          ],
          "correctAnswer": 1
        },
        {
        ...
        },
        {
          ...
          "options": [
            "It is the fastest storage type.",
            "It is used for temporary data.",
            "It is external to the computer system and used for archiving.",
            "It is used only for storing the operating system."
          ],
          "correctAnswer": 2
        },
        {
          ...
          "options": [
            "The process of dividing a large dataset into smaller parts",
            "The process of joining two tables",
            "The process of creating a database backup",
            "The process of indexing a table"
          ],
          "correctAnswer": 0
        },
        {
